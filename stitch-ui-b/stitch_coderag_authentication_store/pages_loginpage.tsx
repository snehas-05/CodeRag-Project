...
/**
 * CodeRAG 2026 Architecture: LoginPage
 * 
 * Features:
 * - Premium split-screen layout.
 * - Reactive form handling with loading states.
 * - Integration with Zustand AuthStore.
...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 items-center justify-center p-12 overflow-hidden border-r border-slate-800">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_30%,rgba(6,182,212,0.1),transparent)]" />
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-indigo-500/10 blur-[120px] rounded-full" />
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-4xl font-bold text-white mb-6 leading-tight">
            The next generation of <span className="text-cyan-400">code intelligence</span>.
          </h1>
          <p className="text-lg text-slate-400 mb-8">
            CodeRAG uses zero-trust workload identity to securely analyze your repositories and solve complex bugs in seconds.
          </p>
          
          <div className="space-y-4">
            {[
              { icon: Layout, text: "High-fidelity RAG visualizations" },
              { icon: Github, text: "Enterprise-grade VCS integration" },
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 md:p-16 lg:p-24 relative">
        <div className="lg:hidden absolute top-8 left-8 flex items-center gap-2">
           ...
           <span className="font-bold text-xl text-white">CodeRAG</span>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-white placeholder:text-slate-600 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 outline-none transition-all"
              />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <a href="#" className="text-xs text-cyan-500 hover:text-cyan-400 transition-colors font-medium">
                  Forgot password?
                </a>
              </div>
              <input
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-cyan-900/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isLoading ? (
